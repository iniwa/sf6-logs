...
- **設計 → 実装の分担**: Codex が設計判断と handoff (`docs/handoffs/YYYY-MM-DD-*.md`) を作成し、`claude -p --model sonnet --permission-mode auto` で委譲した Claude Code (Sonnet 5) が handoff に沿って実装・検証する。詳細は `AGENTS.md` / `CLAUDE.md` を参照。
