...
existing polling/backoff behavior. Production deployment is a separate user
action, not part of this implementation.
...
- No browser was available for visual QA. Optional resume condition: once a
  ...
  or deployment; publishing/deploying remains subject to a new explicit user
  request. Source/runtime checks above do not claim visual verification.
